...
from Feature_Match_Test import *
...
if len(sys.argv) < 2:
  print ("Usage :",sys.argv[0],"detector(= orb ou kaze) test(= test ou blanc)")
  sys.exit(2)
...
if(test):
  img2,transform = build_transform(img1,30,1)
else:
...
if(test):
  test_feature_match(pts1,pts2,good,transform,"ORB" if detector==1 else "KAZE")
